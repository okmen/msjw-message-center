...
public class IAlipayServiceImpl implements IAlipayService {
	...
	public String getAppAuthToken(String appAuthCode) throws AlipayApiException {
		...
		signType="RSA2";
		AlipayClient alipayClient = new DefaultAlipayClient(alipayGateWay, appId, privateKey, "json", charset,alipayPublicKey, signType);
		...
		requestLogin1.setBizContent("{" + "\"grant_type\":\"authorization_code\"," + "\"code\":\"" + appAuthCode + "\"" + "}");
		AlipayOpenAuthTokenAppResponse alipayOpenAuthTokenAppResponse = alipayClient.execute(requestLogin1);
		...
		AlipayClient alipayClient11 = new DefaultAlipayClient(alipayGateWay, appId, privateKey, "json", charset,alipayPublicKey, signType);
		AlipayUserUserinfoShareRequest request = new AlipayUserUserinfoShareRequest();
		requestLogin1.setBizContent("{" + "\"auth_token\":\"6e36a61321074f0daefebaeaf1beTX13\",");
		
		AlipayUserUserinfoShareResponse response = alipayClient11.execute(request);
